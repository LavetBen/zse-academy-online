...
export const Footer = () => {
  return (
    <footer className="bg-[#0B1E39] text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          {/* Brand / About */}
          <div className="lg:col-span-2">
            <Link to="/" className="inline-flex items-center space-x-2 mb-5">
              <img src={ZSELogo} alt="Zimbabwe Stock Exchange" className="h-10 w-auto" />
            </Link>
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              ZSE Training offers professional development courses tailored for Zimbabwe’s financial markets. 
              Learn from experts and earn certifications recognized locally and regionally.
            </p>
            <div className="space-y-3 text-gray-400 text-sm">
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-indigo-400" />
                <span>training@zse.co.zw</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>44 Ridgeway North, Highlands, Harare</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Zimbabwe Stock Exchange Training. All rights reserved.
            </div>
